...
require_once get_stylesheet_directory() . '/includes/single-car/single-car-lucide-icons.php';
            ...
            <aside class="autoagora-single-car__card autoagora-single-car__summary">
                ...
                <div class="autoagora-single-car__seller">
                    <?php if ($author_id) : ?>
                        ...
                        <a class="autoagora-single-car__seller-profile" href="<?php echo esc_url($author_url); ?>">
                            ...
                            <span class="autoagora-single-car__seller-copy">
                                <span class="autoagora-single-car__seller-name"><?php echo autoagora_single_car_lucide_icon('user'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Hardcoded SVG. ?><?php echo esc_html($author_name); ?></span>
                    ...
                    <div class="autoagora-single-car__contact-actions">
                        <?php echo do_shortcode('[car_single_call_button icon_set="lucide"]'); ?>
                ...
                <div class="autoagora-single-car__utility-row">
                    <div class="autoagora-single-car__utility-row-main">
                        <div class="autoagora-single-car__views"><?php echo autoagora_single_car_lucide_icon('eye'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Hardcoded SVG. ?><?php echo do_shortcode('[car_views_counter_single car_id="' . (int) $post_id . '"]'); ?></div>
                        <div class="autoagora-single-car__utility-actions">
                            <?php echo do_shortcode('[share_button design="single" size="normal" icon_set="lucide"]'); ?>
                            <?php echo do_shortcode('[favorite_button car_id="' . (int) $post_id . '" design="single" size="normal" icon_set="lucide"]'); ?>
                            <?php echo do_shortcode('[report_button car_id="' . (int) $post_id . '" design="single" size="normal" icon_set="lucide"]'); ?>
                        </div>
                    </div>
                    <p class="autoagora-single-car__contact-note"><?php echo autoagora_single_car_lucide_icon('info'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Hardcoded SVG. ?><?php esc_html_e('Help the seller by mentioning you found this on Autoagora', 'bricks-child'); ?></p>
                </div>
            </aside>
        </section>
                                                ...
                                                <td>
                                                    <?php if (!empty($spec['url'])) : ?>
                                                        <a class="autoagora-single-car__spec-link" href="<?php echo esc_url($spec['url']); ?>">
                                                            ...
                                                            <span class="autoagora-single-car__spec-link-arrow" aria-hidden="true"><?php echo autoagora_single_car_lucide_icon('arrow-right'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Hardcoded SVG. ?></span>
                                                        </a>
                                                    <?php else : ?>
