...
// TEMPORARY: Car Views Database Creation (REMOVE AFTER RUNNING)
add_action('admin_notices', function() {
    ...
    if (!$table_exists) {
        ...
        echo '<div class="notice notice-success is-dismissible"><p><strong>✅ SUCCESS!</strong> Car views table created: <code>' . $table_name . '</code><br><strong>REMOVE THIS CODE FROM FUNCTIONS.PHP NOW!</strong></p></div>';
    }
});
// END TEMPORARY CODE