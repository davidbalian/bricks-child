...
- browser-free bulk dealership onboarding: `includes/admin/dealer-onboarding/*` plus `scripts/autoagora-onboard-dealers.ps1` (dedicated revocable onboarding token, phone-source provenance enforcement, DPAPI credential storage, disabled/dry-run sync profiles)
