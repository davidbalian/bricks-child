        ...
        if ( is_user_logged_in() ) {
            ...
            if ( isset( $_GET['listing_submitted'] ) && $_GET['listing_submitted'] == 'success' ) {
                ...
                <div class="listing-success-message">
                    ...
                    <p><a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="button"><?php esc_html_e( 'Return to Home', 'bricks-child' ); ?></a></p>
                </div>
                <?php
                ...
                <form id="add-car-listing-form" class="car-listing-form" method="post" enctype="multipart/form-data" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                    ...
                    <div class="add-listing-images-section input-wrapper">
                        ...
                        <p class="image-upload-info"><?php esc_html_e( 'Hold CTRL to choose several photos. Minimum 5 images per listing. Maximum 25 images per listing. Maximum file size is 5MB, the formats are .jpg, .jpeg, .png, .gif, .webp', 'bricks-child' ); ?></p>
                    </div>
                    ...
                    <div class="form-row">
                        <button type="submit" class="submit-button gradient-button"><?php esc_html_e( 'Submit Listing', 'bricks-child' ); ?></button>
                    </div>
                </form>
                <?php
            }
