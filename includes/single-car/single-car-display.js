 ...
 * Main car functionality (read more, favorites, specs toggle, report modal)
 */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (favoriteBtn) {
    favoriteBtn.addEventListener("click", function (e) {
      ...
      if (
        typeof carListingsData === "undefined" ||
        typeof carListingsData.ajaxurl === "undefined" ||
        typeof carListingsData.nonce === "undefined"
      ) {
  ...
  if (reportForm) {
    reportForm.addEventListener("submit", function (e) {
      ...
      if (typeof carListingsData === "undefined") {
        alert(
          "Error: Unable to submit report. Please refresh the page and try again."
        );
        return;
      }
