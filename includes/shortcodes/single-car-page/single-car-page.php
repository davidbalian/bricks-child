...
function single_car_buttons_shortcode($atts) {
    ...
    wp_enqueue_style('single-car-page-css', get_template_directory_uri() . '/includes/shortcodes/single-car-page/single-car-page.css', array(), '1.0.0');
    wp_enqueue_script('single-car-buttons-js', get_template_directory_uri() . '/includes/shortcodes/single-car-page/single-car-buttons.js', array('jquery'), '1.0.0', true);
