    ...
    if ($car_query->have_posts()) :
        while ($car_query->have_posts()) : $car_query->the_post();
            ...
            <div class="car-listing-card" 
                    ...
                    foreach ($all_images as $index => $image_id) {
                        ...
                        if ($image_url) {
                            ...
                            if ($index === count($all_images) - 1 && count($all_images) > 1) {
                                echo '<a href="' . esc_url(add_query_arg('car_id', get_the_ID(), get_permalink(get_the_ID()))) . '" class="see-all-images" style="display: none;">See All Images</a>';
                            }
                            echo '</div>';
                        }
                    }
                ...
                <a href="<?php echo esc_url(add_query_arg('car_id', get_the_ID(), get_permalink(get_the_ID()))); ?>" class="car-listing-link">
